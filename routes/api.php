...
Route::post('servico/procurarname', [ServicoController::class, 'pesquisarPorname']);
...
Route::post('adm/cliente/procurarname', [ClienteController::class, 'pesquisarPorname']);
...
Route::post('adm/cliente/esquecipassword', [ClienteController::class, 'esquecipassword']);
...
Route::post('adm/profissional/procurarname', [ProfissionalController::class, 'pesquisarPorname']);
...
Route::post('adm/esquecipassword', [AdmController::class, 'esquecipasswordAdm']);
